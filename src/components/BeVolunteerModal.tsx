...
export default function BeVolunteerModal({ post, onClose }: BeVolunteerModalProps) {
        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Volunteer Opportunity Details</h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                />
                {errors.suggestion && (
                  <p className="mt-1 text-sm text-red-600">{errors.suggestion.message}</p>
                )}
              </div>

              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p className="text-sm text-yellow-800">
                  <strong>Status:</strong> Your request will be marked as "Requested" and the organizer will review it.
                </p>
              </div>
